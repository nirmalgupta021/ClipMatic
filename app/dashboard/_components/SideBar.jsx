  ...
  return (
    <div className="w-64 fixed h-screen shadow-md p-5">
        <div className="flex gap-2 items-center">
            ...
            <h2 className="font-medium text-lg">ClipMatic</h2>
        </div>

        <ul className="mt-10">
            {menuOption.map((item, index)=>(
                <Link href={item.path} key={index}>
                <li  className={`flex gap-2 items-center p-3 mt-2 hover:bg-slate-200 rounded-lg text-gray-500 hover:text-black cursor-pointer
